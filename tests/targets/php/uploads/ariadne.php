...
$ARIADNE_UUID = '9f93658e-d16f-47ba-bdf0-b8526bd4cd96';
$ARIADNE_AUTH_METHOD = 'cookie';
$ARIADNE_AUTH_NAME = 'session';
$ARIADNE_AUTH_VALUE = 's3cr3t_t0k3n';
$ARIADNE_ENCODING = 'standard_base64';
$ARIADNE_DEFORMED_ALPHABET = '';
$ARIADNE_STANDARD_ALPHABET = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/';
$ARIADNE_ENCRYPTION = 'aes256_cbc';
$ARIADNE_AES_KEY = 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=';
$ARIADNE_REQUEST_TEMPLATE = 'form_post';
$ARIADNE_REQUEST_PARAM = 'data';
$ARIADNE_CAMOUFLAGE_HTML = '<!DOCTYPE html>
<html>
...
';
$ARIADNE_RESPONSE_STATUS = 200;
$ARIADNE_RESPONSE_CT = 'text/html';
$ARIADNE_ENABLE_SOCKS = false;
$ARIADNE_ENABLE_P2P_HTTP = true;
$ARIADNE_ENABLE_P2P_TCP = false;
$ARIADNE_TCP_PORT = 7443;
$ARIADNE_DEBUG = false;
