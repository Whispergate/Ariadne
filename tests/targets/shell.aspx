...
static string ARIADNE_UUID = "41e14e1c-d327-4fbd-8124-1f50bd737330";
...
static string ARIADNE_AES_KEY = "pNDGgeRNddfqxShNPBwKxfuqlIiFpt73rtK4Sj/28/Y=";
...
static byte[] AriadneEncrypt(string plaintext)
{
    ...
    Buffer.BlockCopy(hmac, 0, result, blob.Length, hmac.Length);
...
static string AriadneDecrypt(byte[] data)
{
    ...
    Buffer.BlockCopy(data, 0, ivAndCt, 0, blobLen);
    Buffer.BlockCopy(data, blobLen, hmacReceived, 0, 32);
    ...
    Buffer.BlockCopy(ivAndCt, 0, iv, 0, 16);
    Buffer.BlockCopy(ivAndCt, 16, ciphertext, 0, ciphertext.Length);
